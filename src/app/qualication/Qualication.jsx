      ...
      <div className="qualication__conten container ">
        <div className="qualication__container ">
          <div className="qualication__tabs">
            <div
              className={
                toggleState === 1
                  ? "qualication__button qualication__active button--flex"
                  : "qualication__button button--flex"
              }
              onClick={() => toggleTab(1)}
            >
              <i className="uil uil-graduation-cap  qualication__icon"></i>
              Education
            </div>
            ...
            <div
              ...
              onClick={() => toggleTab(2)}
            >
              <i className="uil uil-briefcase-alt qualication__icon"></i>
              Experience
            </div>
          </div>
        </div>
        ...
        <div className="qualication__sections">
          <div
            className={
              toggleState === 1
                ? "qualication__content qualication__content-active"
                : "qualication__content"
            }
          >
            <div className="qualication__data">
              <CartQuality
                title="Tecnologo Ambiental"
            ...
            <div className="qualication__data">
              <CartQuality
                title="Programacion Basica y Desarrollo de Sotfware"
            ...
            <div className="qualication__data">
              ...
              <CartQuality
                title="Curso Introducctoria a Internet la Web y Programacion"
            ...
            <div className="qualication__data">
              <CartQuality
                title="One Oracles Next Education"
